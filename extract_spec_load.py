...
def main(args):
    _, alphabet = pretrained.load_model_and_alphabet(args.model_location)
    ...
    print(args.glove_model)
    model.load_state_dict(torch.load(args.glove_model))
    model.eval()
    ...
    data_loader = torch.utils.data.DataLoader(
        dataset, collate_fn=G(), batch_sampler=batches
    )
